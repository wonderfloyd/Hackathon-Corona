...
const restaurants = [
  {
    id: '1',
    name: "Becky's Burgers in /content/buildData.js",
    priceRange: '$$',
...
let restaurantsStringified = JSON.stringify(restaurants);
console.log("Restaurants: " + restaurantsStringified);
fs.writeFileSync('./content/restaurants.json', restaurantsStringified);
try {
